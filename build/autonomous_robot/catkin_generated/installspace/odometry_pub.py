...
def encoderCallback(msg):
    ...
    rospy.loginfo(rospy.get_caller_id() + 'msg %s', msg)
...
def ticks_to_odometry():
    ...
    while not rospy.is_shutdown():
        ...
        global encoder3_ticks 
        global encoder4_ticks 
        rospy.loginfo(rospy.get_caller_id() + 'tick2 %s', last_encoder2_ticks)
        ...
        vy =  (R/4)* (-velocity_encoder1+velocity_encoder2+velocity_encoder3-velocity_encoder4)
        vth = (R/(4*(lx+ly)))* (-velocity_encoder1+velocity_encoder2-velocity_encoder3+velocity_encoder4)
        rospy.loginfo(rospy.get_caller_id() + 'vth %s', vth)
        dx= vx * dt
        dy= vy*dt
        dth= vth*dt
        ...
        rospy.loginfo(rospy.get_caller_id() + 'odom %s', odom)
